...
class PriorityQueue<E, P> {
    ...
    public Node add(E e, P priority) {
        ...
        Node added = new Node(e, priority, tree.size());
        //add it in the next open position in the tree
        tree.add(added.idx, added);
        //pull the new node up to its correct position
        pullUp(added.idx);
    ...
    public boolean contains(E e) {
        ...
        //iterate through array until no more slots or item found
        while(!contained && i < tree.size()) {
            contained = tree.get(i).value.equals(e);
            i++;
        }
